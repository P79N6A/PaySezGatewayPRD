...
$search_type = isset( $_GET['type'] ) ? $_GET['type'] : 'trans';
$search_type_text = ($search_type == 'cb') ? 'Chargebacks' : 'Transactions';
	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<div class="row">
					<div class="col-sm-6 b-r"><h3 class="m-t-none m-b"></h3>
							...
							<div class="form-group">
								...
								<select class="form-control m-b" id="dispute_result" name="dispute_result">
							...
							<div class="form-group">
								...
								<select class="form-control m-b" id="status" name="status">
									...
									<option value="2">1st Response Sent to Bank</option>
									<option value="3">1st Response Received From Bank</option>
									<option value="4">2nd Response Sent to Bank</option>
									<option value="5">2nd Response Received From Bank</option>
									<option value="6">3rd Response Sent to Bank</option>
									<option value="7">3rd Response Received From Bank</option>
									<option value="8">4th Response Sent to Bank</option>
									<option value="9">4th Response Received From Bank</option>
				...
				<div class="row">
					<div class="col-sm-6">
						<?php if($search_type == 'cb') { ?>
						<input type="hidden" name="new_chargebacks" id="new_chargebacks" value="0" />
						<button class="btn btn-danger btn-lg btn-block cbsearchnew" type="button"><i class="fa fa-search"></i> All New Chargebacks <?php if(!empty($chargebacks)) printf('(%s)', $chargebacks) ?></button>		
					<?php } ?>
					</div>
					<div class="col-sm-6">

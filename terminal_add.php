                    ...
                    <div class="ibox-content">
                        <div>
                            ...
                            if($userDet['username'] == "hutchadminuser") {
                                ...
                                $mer_id_det = $db->getone("merchants");
                                $mer_id = $mer_id_det['mer_map_id'];
                            } else {
                                $mer_id = '';
                            }
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3  mrb-15">
                                            ...
                                            <input class="form-control" type="text" name="pg_merchant_id" id="pg_merchant_id" value="<?php echo $mer_id; ?>" <?php if($mer_id!='') { echo "readonly"; } ?>>
                                        </div>
                                        <div class="col-sm-3  mrb-15">
                                            <label>Terminal ID</label><BR>
                                            <input class="form-control" type="text" name="pg_terminal_id" id="pg_terminal_id">
                                        </div>
										<div class="col-sm-3  mrb-15">
...
function terminal() {
    ...
    if(pg_terminal_id.length != 8) {
        swal(' Terminal Id should be of length 8');
        return false;
    }

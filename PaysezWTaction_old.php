...
$merchant_id = strlen(trim($_POST['merchant_id'])) == 3 ? "E01010000000038" : trim($_POST['merchant_id']);
$vendor_payment_options = "WT";
$vendor_name = "AirPay"; // "AirPay_TestProd"; // "AirPay"; // "BillDesk";
...
if($vendor_name == "AirPay") {
    ...
    $data = Array(
      ...
      "WT_amount" => $amount; // trim($_POST['amount']),

...
<div class="content" id="pay" style="display:block;">
        ...
        <div class="col-sm-3">
            ...
            <table>
                ...
                <tr id="otn"><td><b>PARTNER TRANSACTION ID(Orig unique no)</b></td><td><input type="text" name="orig_out_trade_no" id="orig_out_trade_no" value="" required="required"></td></tr>

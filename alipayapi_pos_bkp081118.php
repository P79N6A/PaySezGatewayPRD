...
//订单名称，必填
//order name  ,not null
$subject = 'Alipay';//$_POST['WIDsubject'];
...
//pos test 210918
    ...
    if($ttype == 1) {               /* ttype =1 ,Purchase request */
        ...
        // $given_datetime = $terminal_timestamp;//$project['trans_datetime'];
        ...
        $sale_time_ind = date('Y-m-d H:i:s');
        $given_ref_sale = new DateTime($sale_time_ind);
        $given_ref_sale->setTimezone(new DateTimeZone("Asia/Hong_Kong"));
        $updated_datetime = $given_ref_sale->format("Y-m-d H:i:s");
        ...
        if($count >=1){
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $otn_log . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        if($_POST['terminal_id']!="") {
            ...
            if($terminalIdds != "" && $terminal_active == 1){
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $terminal_active_sts . PHP_EOL, FILE_APPEND | LOCK_EX);
                echo 'Terminal Id Not Active';
                exit;
                die();
            }else {
                $terminal_id_empty = "POS terminal Id wrong Log:\n".date("Y-m-d H:i:sa") . "\n---------------------\nReceived wrong terminal From pos:\n" .$terminal_wrong. " \n\n";
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $terminal_id_empty . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        /* Currency Match with Terminal to merchant */
         ...
         if($currency_code != $currency){
            $currency_received = array(
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $currency_status . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $pos_data_log . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $log . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        if ($result_code != "SUCCESS" && $result_code != "") {
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $pay_err_res_upd . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $pay_err_res . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $pay_emp_res_upd . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $pay_err_res_emp . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $final_pay_res = date("Y-m-d H:i:sa") . "\n---------------------\nFianl payment Response update in table:\n" . json_encode($data) . " \n\n";
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $final_pay_res . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $trans_suc_update = $db->update('transaction_alipay', $data);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $pay_success_res . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $mer_access_permsn . PHP_EOL, FILE_APPEND | LOCK_EX);
    ...
    exit;
        ...
        if($_POST['terminal_id']!="") {
            ...
            if($terminalIdds != "" && $terminal_active == 1){
                ...
                $store_id = $storeid;
            if($mso_location == ""){
                $loc_name = trim($secondary_merchant_name,"Duty Free PVT LTD");
                $store_name = $loc_name;
            }else{
                $store_name = $mso_location;
        }
    ...
    //     $str = explode("~",$pcrq);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $ref_req_data_pos . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        if ($result_code == "SUCCESS") {
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $refund_succ_res_upd . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $refund_suc_res_pos_log . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $refund_empty_res . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $refund_empty_res_pos . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $refund_err_res_upd . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $refund_err_res_pos_log . PHP_EOL, FILE_APPEND | LOCK_EX);
...
exit;
    ...
    //     $str = explode("~",$pcrq);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $query_log . PHP_EOL, FILE_APPEND | LOCK_EX);
...
/* Checking transaction success or not ,if success dont send request to alipay */
        ...
        if($trade_status == 'TRADE_SUCCESS'){
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $trans_succ_log . PHP_EOL, FILE_APPEND | LOCK_EX); 
    ...
    /* Query data log ,send to alipay*/
        ...
        $partner_trans_id = $alipaySubmit->get_from_tag($server_output,'<partner_trans_id>', '</partner_trans_id>');
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $query_response . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $query_update4 = $db->update('transaction_alipay', $query_trade_res_pos);
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $query_trade_res_pos1 . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        /* Updating query Success response in transaction table */
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $query_response_to_pos . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $query_response_pos . PHP_EOL, FILE_APPEND | LOCK_EX);
    ...
    //     $str = explode("~",$pcrq);
        ...
        if($str[1] == 1){
            ...
            $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $can_data_pos . PHP_EOL, FILE_APPEND | LOCK_EX);
        ...
        $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $log . PHP_EOL, FILE_APPEND | LOCK_EX);
            ...
            if ($result_code == "SUCCESS") {
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $can_response_success . PHP_EOL, FILE_APPEND | LOCK_EX);
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $can_succs_res_pos . PHP_EOL, FILE_APPEND | LOCK_EX);
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $can_response_error . PHP_EOL, FILE_APPEND | LOCK_EX);
                ...
                $myfile = file_put_contents('/var/www/html/testspaysez/api/alipaytranLOG.log', $can_err_res_pos . PHP_EOL, FILE_APPEND | LOCK_EX);

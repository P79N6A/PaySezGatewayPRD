...
<?php date_default_timezone_set('Asia/Kolkata'); ?>
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" onsubmit="return confirm('Do you really want to submit the form?');">
			...
			<div class="element">
				<div class="etitle">refund_amount:</div>
				<div class="einput"><input type="text" name="refund_amount" value=""></div>
				<br>
			</div>
			<div class="element">
				<div class="etitle">refund_reason:</div>
				<div class="einput"><input type="text" name="refund_reason" value=""></div>
				<br>
			</div>
			<div class="element">
				<div class="etitle">refund_currency:</div>
				<div class="einput"><input type="text" name="refund_currency" value="USD"></div>
				<br>
			</div>
			<div class="element">
				<div class="etitle">operator_id:</div>
				<div class="einput"><input type="text" name="operator_id" value=""></div>
				<br>
			</div>
			<div class="element">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="tran_req_type" value="PA5"></div>
				<br>
			</div>		
			<div class="element">
				...
				<input type="hidden" name="method" value="alipay.trade.refund">
				<input type="hidden" name="Pre_Auth"  id="Pre_Auth" value="refund">
			<!-- <input type="hidden" name="tran_req_type"  id="tran_req_type" value="PA5"> -->
			</div>
			<div class="element" >
				<input type="submit" class="alisubmit" value ="Refund">
			</div>
		</form>
	</div>
</body>

...
<?php date_default_timezone_set('Asia/Kolkata'); ?>
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" onsubmit="return confirm('Do you really want to submit the form?');">
			...
			<div class="element">
				<div class="etitle">operation_id:</div>
				<div class="einput"><input type="text" name="operation_id" value=" "></div>
				<br>
			</div>
			<div class="element">
				<div class="etitle">out_order_no:</div>
				<div class="einput"><input type="text" name="out_order_no" value=" "></div>
				<br>
			</div>
			<div class="element">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="tran_req_type" value="PA6"></div>
				<br>
			</div>
			<div class="element">
			...
			<div class="element">
				...
				<br>
			<input type="hidden" name="remark" value="PreAuth Cancle">
			<input type="hidden" name="method" value="alipay.fund.auth.operation.cancel">
			<input type="hidden" name="app_id" value="2018060601228996">
			<input type="hidden" name="version" value="1.0">
			<input type="hidden" name="Pre_Auth"  id="Pre_Auth" value="cancel">
			<!-- <input type="hidden" name="tran_req_type"  id="tran_req_type" value="PA6"> -->
			</div>
			<div class="element" >
				<input type="submit" class="alisubmit" value ="Cancel">
			</div>
		</form>
	</div>
</body>

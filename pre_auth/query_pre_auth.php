	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" onsubmit="return confirm('Do you really want to submit the form?');">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="auth_code"  value=""></div>
				<br>
			</div>
			<div class="element">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="tran_req_type" value="PA2"></div>
				<br>
			</div>
			<div class="element">
				...
				<br>
			<input type="hidden" name="method" value="alipay.fund.auth.operation.detail.query">
			<input type="hidden" name="app_id" value="2018060601228996">
			<input type="hidden" name="version" value="1.0">
			<input type="hidden" name="Pre_Auth"  id="Pre_Auth" value="query">
			<!-- <input type="hidden" name="tran_req_type"  id="tran_req_type" value="PA2"> -->
			</div>
			<div class="element" >

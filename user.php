				...
				<form role="form" id="user_edit" action="" method="post">
					<div class="row">
						<div class="col-sm-6 b-r"><h4>User Information</h4>
							...
							<?php } else{ ?>
								<div class="form-group"><label>Merchants</label>
									<select class="form-control m-b" name="merchants" id="merchants" <?php if($iiduserdata['username'] == "hutchadminuser") { ?> disabled <?php } ?>>
										<option value="">-- All Merchants --</option>
										<?php 
										foreach($user_merchants as $user_merchant) { ?>
											<?php if($iiduserdata['username'] == "hutchadminuser") { ?>
											<option value="<?php echo $user_merchant['idmerchants']; ?>" 
												<?php if($user_merchant['idmerchants'] == $iiduserdata['merchant_id']) { ?> selected="selected" <?php } ?> >
												<?php echo $user_merchant['merchant_name']; ?></option>
											<?php } else { ?>
											<option value="<?php echo $user_merchant['idmerchants']; ?>" 
												<?php if($user_merchant['idmerchants'] == $_POST['merchants']) { ?> selected="selected" <?php } ?> >
											...
											<?php } ?>
										<?php } ?>
										<input type="hidden" name="merchants_id" value="<?php echo $iiduserdata['merchant_id']; ?>">
									</select>
								</div>
								...
								<?php
								$idmerchants = $iiduserdata['merchant_id'];
								$user_type   = $iiduserdata['user_type'];
								$db->where("idmerchants",$idmerchants);
								$terminalDet = $db->get("terminal");
								?>
								<div class="form-group"><label>Terminals</label>
									<select class="form-control m-b" name="terminals" id="terminals">
										<option value="">-- Terminals --</option>
										<?php 
										foreach($terminalDet as $ter) {
										?>
											<option value="<?php echo $ter['mso_terminal_id']; ?>">
												<?php echo $ter['mso_terminal_id']; ?></option>
										<?php
										}
										?>
									</select>
						...
						<div class="col-sm-6">
							...
							switch($iiduserdata['user_type']){
								case 1:
									...
									if(in_array($iiduserdata['username'], array("supremeuser", "hutchadminuser"))) {

...
$secureData = $_POST['amount'].$_POST['bankCode'];
...
if($vendor_name == "BillDesk") {
    ...
    $BankID  = $_POST['bankCode'];  // 'IOB'; // 'BOM'; // 'IDS'
    ...
    $logs = $vendor_name."'s ".$payment_option." Request Data:".date("Y-m-d H:i:s") . "\n" .$str. " \n\n";
    logwrite($logs);
    ...
    $data = Array(
      ...
      "NB_buyerCountry" => trim($_POST['buyerCountry']),
      ...
      "NB_transactionid" => trim($CustomerID),
...
if($vendor_name == "AirPay") {
    ...
    $amount = $amount; // trim($_POST['amount']);

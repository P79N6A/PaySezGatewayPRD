...
<div class="container">
    ...
    <div class='row'>
        <form  role="form" method="post" action="api/switch_api.php">
            <div class='col-md-2'></div>
            <div class='col-md-8'>
                <div class='form-row'>
                    <div class='col-xs-6 form-group required'>
                        <label class='control-label'>walletid <span class="text-danger">*</span></label>
                        <input class='form-control' type='text' name="walletId" value='0'>
                    </div>
                    <div class='col-xs-6 form-group required'>
                        <label class='control-label'>Transfer Type <span class="text-danger">*</span></label>
                        <input class='form-control' type='text' name="transType" value='0'>
                    </div>
                </div>
                <div class='form-row'>
                    <div class='col-xs-6 form-group'>
                        <label class='control-label'>merchantId</label>
                        <input class='form-control' type='text' name="merchantId" value='1'>
                    </div>
                    <div class='col-xs-6 form-group'>
                        <label class='control-label'>terminalId</label>
                        <input class='form-control' type='text' value='1' name="terminalId">
                    </div>
                </div>
                <div class='form-row'>
                    <div class='col-xs-6 form-group'>
                        <label class='control-label'>city</label>
                        <input class='form-control' type='text' name="city" value='fort'>
                    </div>
                    <div class='col-xs-6 form-group'>
                ...
                <div class='form-row'>
                    <div class='col-xs-6 form-group'>
                        <label class='control-label'>TINN</label>
                        <input class='form-control' type='text' name="tinn" value='33065'>
                    </div>
                    <div class='col-xs-6 form-group'>
                ...
                <div class='form-row'>
                    <div class='col-xs-6 form-group required'>
                        <label class='control-label'>token <span class="text-danger">*</span></label>
                        <input class='form-control' type='text' name="token" value='6080800000025026'>
                    </div>
                    <div class='col-xs-6 form-group'>
                        <label class='control-label'>Amount</label>
                        <input class='form-control' type='text' name="transAmount" value='6080800000025026' >
                    </div>
                </div>
            </div>
            <div class='col-md-2'></div>
    ...
    <div class='row'>
        ...
        <div class='col-md-8'>
            <div class='form-row'>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>CurrCode</label>
                    <input class='form-control' type='text' value='356' name="transCurrCode">
                </div>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>cvv2</label>
                    <input class='form-control' type='text' value="519" name="cvv2">
                </div>
            </div>
            <div class='form-row'>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>CountryCode</label>
                    <input class='form-control' type='text' name="transCountryCode" value="356">
                </div>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>Date and Time</label>
                    <input class='form-control' type='text' name="dateAndTime" value="0703060640">
                </div>
            </div>
            <div class='form-row'>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>ref Nbr</label>
                    <input class='form-control' type='text' name="refNbr" value="000013">
                </div>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>local Date</label>
                    <input class='form-control' type='text' name="localDate" value="0703">
                </div>
            ...
            <div class='form-row'>
                <div class='col-xs-6 form-group'>
                    ...
                    <input class='form-control' type='text' name="localTime" value="060640">
                </div>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>Exp Date</label>
                    <input class='form-control' type='text' name="expDate" value="1711">
                </div>
            ...
            <div class='form-row'>
                <div class='col-xs-6 form-group'>
                    ...
                    <input class='form-control' type='text' name="Source" value="2">
                </div>
				<div class='col-xs-6 form-group'>
                    <label class='control-label'>MCC</label>
                    <input class='form-control' type='text' name="MCC" value="5999">
                </div>
                
            </div>
            <div class='form-row'>
                <div class='col-xs-6 form-group'>
                    <label class='control-label'>RRN</label>
                    <input class='form-control' type='text' name="RRN" value="000619574329">
                </div>

                <div class='col-xs-6 form-group'>
                    <label class='control-label'>Redirect URL</label>
                    <input class='form-control' type='text' name="callback" value="http://">
                </div>
        ...
        <div class='col-md-8'>
            ...
            <div class='form-row'>
                ...
                <div class='col-xs-4 form-group required'>
                  ...
                  <input class='form-control' type='text' name="merchant_id" value='1'>
                </div>
                <div class='col-xs-4 form-group required'>
                  <label class='control-label'>Gateway ID <span class="text-danger">*</span></label>
                  <input class='form-control' type='text' name="platform_id" value='2'>
                </div>
                <div class='col-xs-4 form-group required'>
                  <label class='control-label'>Bank ID <span class="text-danger">*</span></label>
                  <input class='form-control' type='text' name="processor_id" value='2'>
                  <input class='form-control' type='hidden' name="gateway_id" value='2'>

...
//$merchant_id=$_POST['gateway_id-0-0:2'];
...
print_r($arr_merchant_acuity_fees);
echo "<br>part 2<br>";
print_r($arr_merchant_acuity_fees);
...
print_r($success_merchant_acuity_fees);
echo "<br>part 2<br>";
print_r($success_merchant_gateway_fees);
...
function merchant_gateway_fees($arr_merchant_gateway_fees){
	...
	$v=$db->insert('merchant_gateway_fees', $final);
	print_r($v);
	return true;	
}

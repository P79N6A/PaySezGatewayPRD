...
//get all agent users
	...
	// if($_POST) {
	// 	echo $iiduserdata['username']; exit;
	// 	echo "<pre>";
	// 	print_r($_POST); exit;
	// }
	...
	if(isset($_POST['adduserform'])) {
		...
		//generate random password 
			...
			if($iiduserdata['username'] == "hutchadminuser") {
				$addnewu = addnewuserii_terminal($_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['username'],$_POST['user_type'],$iiduserdata,$new_hash,$_POST['merchants_id'],$_POST['terminals']);
			} else {
				$addnewu = addnewuserii($_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['username'],$_POST['user_type'], $iiduserdata, $new_hash, $_POST['merchants']);
			}
...
function addnewuserii_terminal($first_name, $last_name, $email_address, $username, $user_type, $iiduserdata, $newpass, $usr_merchant, $usr_terminal){
	global $db;
	...
	$data = Array (
		...
		'password' => $newpass,
		'user_type' => $user_type,
		'merchant_id' => $usr_merchant,
		'terminal_id' => $usr_terminal
	);
...
function addnewuserii($first_name, $last_name, $email_address, $username, $user_type, $iiduserdata, $newpass, $usr_merchant){

...
<center>
<br>
<input type="radio" name="tab" onclick="alipay()" >
<img src="http://169.38.91.246/img/alipay_logo.png" style="
    width: 143px;
    height: 39px;
">
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="tab"  onclick="debcred()">CREDIT/DEBIT CARD
</center>
-->
<br><br>
<div id="test">
        ...
        <div class="col-sm-3">
            ...
            <form action="alipayapi.php" class="alipayform" method="post" target="_blank">
				<?php $tno="test".date('Ymdhis'); ?>
                    ...
                    <input type="hidden" name="merchantid" value="<?php echo $redoutput['merchantid'];?>">
                        ...
                        <b>Amount:</b><br>
                        <input class="form-control" type="text" name="WIDtotal_fee" value="" required>
                        ...
                        <br><br>
                    <input type="hidden" value="<?php echo 'http://169.38.91.246/resp.php?rrurl='.$_POST['redirectionurl'];?>" name="return_url" >

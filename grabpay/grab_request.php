...
switch ($tran_req_type) {
    case "1": //QR request
        ...
        $parameter_ins = array(
            ...
            "gp_msgID" => $msgID,
            "gp_grabID" => $grabID,
            "gp_merchant_id_grab" => $grabID,
            "gp_terminal_id_grab" => $terminal_id_orig,
    ...
    case "3": //Cancel Request
        ...
        $trans_details = $db->getOne("gp_transaction");

        $can_amount = $trans_details['gp_amount'];

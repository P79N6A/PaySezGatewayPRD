	...
	if (uid == "") {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				window.location = 'http://<?php echo $_SERVER['HTTP_HOST']; ?>/testspaysez/grabpay/admin/dashboard.php';
			}
		}
								...
								<div class="row">
									...
									<div class="col-md-2">
									    ...
									    <select class="form-control m-b" name="transaction_type" id="transaction_type">
											...
											<option value="4">GP Cancel</option>
											<option value="3">GP Inquiry </option>
											</select>
									</div>
								</div>
								<div class="row">

            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div>
                            <?php
                           $query = "SELECT * FROM merchants INNER JOIN users ON merchants.userid = users.id ORDER BY users.id asc";
                             ...
                             <div class="row show-grid">
                                ...
                                <div class="col-md-16">
                                  ...
                                  <div class="panel panel-primary">
                                    ...
                                    <div class="panel-heading">User Accounts  <div class="frmSearch">
                                        <b> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  </b>
                                        <!-- <input type="text" id="search-box" name="ter_id" placeholder="Search Username" style=" background: cadetblue;"/>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example">
                                          <thead>
                                            <tr>
                                              ...
                                              <th><span class="notice"><b>Merchant_Name</b></span></th>

                                              <th><b>Merchant_ID</b></th>
                                          ...
                                          <tbody>
                                            ...
                                            ?>
                                              ...
                                              <tr class="gradeX" data-level="1" id="level_1_<?php echo $row0['mer_map_id']; ?>" class="agentuser">
                                               ...
                                               <td class="data"><?php echo $row0['merchant_name']; ?></td>

                                               <td class="data"><?php echo $row0['mer_map_id']; ?></td>

                                               <td class="data"><?php echo $row0['username']; ?></td>

                                               <td class="data"><?php echo $row0['email_address']; ?></td>

                                                                         
                                               <td class="data">   
                                                
                                                 <!-- <input type="button" class = "btn btn-primary btn-xs" value="Details" onclick="window.location.href='terminal_Details.php?m_id=<?php //echo base64_encode( json_encode($row0['mer_map_id']) ) ?>'" /> -->

                                                 <!-- <input type="button" class = "btn btn-primary btn-xs" value="Edit" onclick="window.location.href='terminal_Editdetails.php?m_id=<?php //echo base64_encode( json_encode($row0['mer_map_id']) ) ?>'" /> -->
                                                 ...
                                                 <button class = "btn btn-primary btn-xs" class="test" data-toggle = "modal" id="<?php echo $row0['mer_map_id']; ?>" onclick="showdetails(this);" data-target="#confirm-submit" name="<?php echo $row0['merchant_name']; ?>"
                                                   value="<?php echo $row0['username']; ?>"<?php if($active == "Active") { ?> disabled <?php } ?>   > Delete </button> <?php if($active == "Active") { ?> <div class="help"><div class="info-box"> <a href="#" class="close-button">&times;</a> You active Terminal so
             ...
             <div class="modal-dialog">
               <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input type="hidden" name="username_name1" id="username_name1">
                  <p> Merchant Name:  &ensp;<span id="merchant_name" style="font-weight: bold;"></span> and Username: &ensp;<span id="username_name" style="font-weight: bold;" ></span> </p>
...
function submitDelete(){
    ...
    var username_name = $('#username_name1').val();
    $('.modal').modal('hide');
    // alert(mer_id);
    // alert(ter_id);
     ...
     $.ajax({
        url: "php/inc_reportsearch1.php",
        data: JSON.stringify({'m_id':mer_id,'type':'getuserdetele'}),
        type: 'POST',
        success: function(data) {
          $('.modal').modal('hide');
  ...
  function showdetails(button) {
    ...
    // ajax request
    var username_name = button.value;
    ...
    $('#merchant_id').val(mer_id);
    $('#username_name').text(username_name);
    $('#username_name1').val(username_name);

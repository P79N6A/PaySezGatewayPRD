...
<nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="<?php active('merchant_add.php');active('terminal_add.php');active('merchant_status_change.php');active('terminal_status_change.php');active('users.php');active('listmerchants.php');active('listterminals.php');active('upi_trans_history.php');active('upi_qr_generate.php');active('merchant_Details.php');?>" >
						...
						<ul class="nav nav-second-level">
							...
							<li class="<?php active('merchant_add.php');active('terminal_add.php');active('merchant_status_change.php');active('terminal_status_change.php');active('users.php');active('listmerchants.php');active('merchant_Details.php');active('listterminals.php');active('upi_qr_generate.php');active('cbp_merchant_reg.php');?>"> 
							...
							<a href=""><i class="fa fa-money"></i> <span
                             class="nav-label">Merchant</span><span class="fa arrow"></span></a>
								...
								<ul class="nav nav-third-level">
									...
									<li class="<?php active('merchant_status_change.php');?>">
										<a href="merchant_status_change.php"><span class="nav-label">Merchant   Status Change</span></a>
									</li>

									<li class="<?php active('terminal_status_change.php');?>">
										<a href="terminal_status_change.php"><span class="nav-label">Terminal   Status Change</span></a>
									</li>
									...
									<?php } ?>
									<li class="<?php active('listmerchants.php');?>">
                        			     <a href="listmerchants.php"><span class="nav-label">View Merchants</span> </a></li> 
                        			 <li class="<?php active('listterminals.php');?>">
                        			     <a href="listterminals.php"><span class="nav-label">View Terminals</span> </a></li> 
							...
							<!-- <li class="<?php // active('vendor_add.php');?>" >

								<a href=""><i class="fa fa-money"></i>
									<span class="nav-label">Vendor</span><span class="fa arrow"></span>
								</a>

								<a href=""><i class="fa fa-money"></i> 
								<span class="nav-label1">Vendor</span>
								<span class="fa arrow"></span></a>

								<ul class="nav nav-third-level">
									<li class="<?php // active('vendor_add.php');?>">
										<a href="vendor_add.php"><span class="nav-label">Add Vendor</span></a>
									</li>
								</ul>
							</li> -->

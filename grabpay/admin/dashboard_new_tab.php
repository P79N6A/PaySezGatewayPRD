...
<div id="exTab2" class="container no-padding">	
		...
		foreach ($vendor as $key => $value) {
			if(in_array($value, ['alipay', 'grabpay'])) {
				...
				<li class="<?php echo $active; ?>">
					<a href="#<?php echo $value; ?>" data-toggle="tab"><?php echo ucfirst($value); ?></a>
				</li>
				<?php
			}
		}

		$vendorCnt = count($vendor);
		if($vendorCnt == 1) {
			if($vendor['alipay'] == 'alipay') {
				$ali_flag = 'active';
			}
			if($vendor['grabpay'] == 'grabpay') {
				$grab_flag = 'active';
			}
			$aflag = '';
		} else {
	...
	<div class="tab-content">
		<div class="tab-pane <?php echo $aflag; ?><?php echo $grab_flag; ?>" id="grabpay">
		...
		<div class="tab-pane <?php echo $ali_flag; ?>" id="alipay">
			...
			// print_r($merchants_details);
			?>
			<?php include_once('dash_alipay_tab.php'); ?>
		</div>
	</div>
</div>
...
<!-- ChartJS-->
	...
	$(document).ready(function(){
	        ...
	        datasets: [
	           	{
	                ...
	                data: [<?php echo $transCnts_alipay;?>]
	    ...
	    var ctx_1 = document.getElementById("lineChart1").getContext("2d");
	    var myNewChart_1 = new Chart(ctx_1).Line(lineData_1, lineOptions_1);

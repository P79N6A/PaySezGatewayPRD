...
if (isset($_POST['username']))
{
    ...
    if ($result != false)
    {
        ...
        if($_SESSION['is_first_login'] == 1) {
        	...
        	header("location:/testspaysez/grabpay/admin/first_login_password_change.php");
        	exit();
        } else {
        	//header("location:/dashboard.php"); //to redirect back to "index.php" after logging out
        	header("location:/testspaysez/grabpay/admin/dashboard.php"); //to redirect back to "index.php" after logging out
        	exit();
        }
        exit();
    }
    ...
    <body class="gray-bg">
        ...
        <div class="middle-box text-center loginscreen  animated fadeInDown">
            <div>
                ...
                <!-- <h1 class="logo-name"><img src="img/spimg/Logo-Transparent 2.png"  alt="logo" width="300px"/></h1> -->
                <h1 class="logo-name"><img src="img/spimg/revopay_logo.png" alt="logo" width="300px"/></h1>
                <!-- <br> -->
                </div>
                <?php echo $msg; ?>
                <form class="m-t" role="form" action="https://paymentgateway.test.credopay.in/testspaysez/grabpay/admin/login.php" method="post">

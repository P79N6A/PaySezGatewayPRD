...
<button class="tablink" onclick="openPage('Home', this, 'red')" id="defaultOpen">Grabpay</button>
<button class="tablink" onclick="openPage('News', this, 'green')" >Alipay</button>
...
$(document).ready(function(){
	...
	// //alert(myDate);
	// //var myDate = (myDate1 == "undefined") ? "" :myDate1 ;
	// var period_start_date = myDate.slice(0, 10);
 //    var period_end_date = myDate.slice(12, 25);
 //    // if(myDate!='') {
 //    //         $('.rlt_row').show();

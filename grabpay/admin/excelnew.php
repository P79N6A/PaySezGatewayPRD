...
// Create new PHPExcel object
       ...
       //    // function excelnew(){
    //    print_r($_GET['merchant_id']);
    // $merchant_id = $_GET['merchant_id'];

    //    $sql = "SELECT * FROM gp_transaction WHERE gp_merchant_id ='$merchant_id' AND gp_terminal_id='GPT000000002'";
              ...
              foreach ($Terminal_ids as $details){
                   ...
                   $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    $terminal_id = $details['mso_terminal_id'];
                        // echo $terminal_id;
                        // echo "<br>";
                    $sql ="SELECT * FROM gp_transaction WHERE gp_merchant_id ='$merchant_id' AND  gp_transaction_type='1' AND gp_status='success' AND gp_terminal_id='$terminal_id' AND gp_trans_date='$date'";
                                      ...
                                      foreach($details1 AS $subrow) {
                                            ...
                                            $objPHPExcel->getActiveSheet()
                                             ...
                                             $objPHPExcel->setActiveSheetIndex(0)
                                                          ...
                                                          ->setCellValue('H'.$i,$previous_date);

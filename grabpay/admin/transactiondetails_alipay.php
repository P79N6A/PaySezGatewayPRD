...
require_once( 'php/inc_chargebacks_alipay.php');
						...
						<table  class="table table-bordered">
							<tbody>
								...
								<tr>
									...
									<td>
									<?php 
									if($trans['transaction_type'] == 1 || $trans['transaction_type'] == 3 || $trans['transaction_type'] == 's1' || $trans['transaction_type'] == 's4'|| $trans['transaction_type'] == 's3' || $trans['transaction_type'] == 's3') {
								...
								<tr>
									<th>Status</th>
									<td><?php
										if($trans['transaction_type'] == 1 || $trans['transaction_type'] == 's1') {
	                                    ...
	                                    } else if($trans['transaction_type'] == 2 || $trans['transaction_type'] == 3 || $trans['transaction_type'] == 's2' || $trans['transaction_type'] == 's4') {
	                                    	if($trans['result_code'] =='SUCCESS') {
	                                    		echo 'SUCCESS';
	                                    	} else {
	                                    		echo "Failed";
	                                    	}
								...
								<tr>
									<th>Settled Date</th>
									<td><?php echo $trans["cst_trans_datetime"]; ?></td>
								</tr>
								<!--<tr>
									<th>Goods Details</th>
						...
						<form id="vtrefundform">
							...
							<div class='row'>
								...
								<div class='col-xs-12 form-group threebtns'>
									...
									<?php if($trans["merchant_id"] == 'E01010000000126') { ?>
									<div class="col-xs-12 form-group no-padding">
										...
										<p><?php echo $data_refund[0]['res_field_2']; ?></p>
										<?php } else { ?>

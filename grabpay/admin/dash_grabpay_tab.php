						...
						<div class="ibox-title iboxsummary">
							...
							<div class="col-xs-5 col-sm-4 date-sec" style="position: relative;">
								...
								<div class="input-group date datesummary" style="right: 111px;">
									...
									<input class="form-control" name="date2" id="date2" type="text" autocomplete="off" value="">
						   ...
						   <input type="hidden" name="date_12" id="date_12" value="<?php echo date('m/d/Y'); ?>">
							<div class="col-xs-3 col-sm-3">
								<div class="form-group"> <!-- Date input -->
									...
									<input class="form-control" id="period_start_date" name="date" placeholder="MM/DD/YYY" autocomplete="off" type="text"  />
								</div>
							</div>
							...
							<div class="col-xs-3 col-sm-3">
								<div class="form-group"> <!-- Date input -->
									...
									<input class="form-control" id="period_End_date" name="date" placeholder="MM/DD/YYY" autocomplete="off" type="text" />
								</div>
							</div>

...
<!-- ChartJS-->
	...
	$('#date_2').on("change", function () {
		...
		.done(function( msg ) {
			...
			$("#exportlink_date").attr("href", "php/inc_transsearch_alipay.php?start_d="+period_start_date+"&end_d="+period_end_date+"&session_id="+session_id);
		});

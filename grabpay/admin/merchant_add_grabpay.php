                    ...
                    <div class="ibox-content">
                        <div>
                            ...
                            <form action="#" onsubmit="return merchant()" autocomplete="off" method="POST">
                             ...
                             <legend> GrabPay : -</legend> 
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3 mrb-15">
                                            <label>Grab_Merchant ID <span id="color">*</span></label><BR>
                                            <input class="form-control" type="text" name="grab_merchant_id" id="grab_merchant_id" maxlength='50'>
                                        </div>
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-5 mrb-15">
                                            ...
                                            <label class="checkbox-inline"><input type="checkbox" name="Permission3" value="1" checked>Inquery</label>
                                          ...
                                          <?php if($i=='2') { ?>
                                            <div class="input-group"> 
                                                <span class="input-group-addon my-addon" style="width: 114px;">
                                                    <input type="checkbox" aria-label="..." id="<?php echo $value['id']; ?>" name="<?php echo $value['vendors']; ?>" value ="<?php echo $value['id']; ?>"   checked="checked" >&nbsp;<?php echo $value['vendors']; ?>
                                                </span>
...
document.getElementById('2').onchange = function() {
    ...
    $("#Grabpay").attr("required", "true");
};
if ($("#2").is(':checked')){
     $('#Grabpay').removeAttr("disabled");
    $("#Grabpay").attr("required", "true")
}

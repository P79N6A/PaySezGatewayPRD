...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
	    ...
	    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
	        <div class="ibox float-e-margins">
	            <div class="ibox-title">
				<button class="label label-warning pull-right" id="monthbtn" onclick="month_show_alipay();">This Month</button>
				<button class="label label-primary pull-right" id="weekbtn" onclick="week_show_alipay();">This Week</button>
				<button class="label label-primary pull-right" id="todaybtn" onclick="today_show_alipay();">Today</button>
		                ...
		                <div class="col-xs-12 col-sm-12">
							<div class="row">
							  <div class="col-xs-7 col-sm-7 five-three" style="font-size: 14px;">
							    <div class="row" id="month-payment_alipay">
                                  ...
                                  <div class="row" id="today-payment_alipay" style="display: none;">
                                  ...
                                  <div class="row" id="week-payment_alipay" style="display: none;">
                                      <div class="col-xs-4 col-sm-4">
							  ...
							  <div class="col-xs-5 col-sm-5 five-two">
							    <div class="row"  id="month-payment_alipay1">
                                  ...
                                  <div class="row" id="today-payment_alipay1" style="display: none;">
                                      <div class="col-xs-6 col-sm-6">
                                          <h5 class="no-margins f-w-b">Cancel</h5>
                                  ...
                                  <div class="row"  id="week-payment_alipay1" style="display: none;">
                                      <div class="col-xs-6 col-sm-6">
                                          <h5 class="no-margins f-w-b">Cancel</h5>
	...
	<div class="col-lg-12">
		...
		<div class="ibox float-e-margins no-margins"><center><span style="color:red"><?php echo $omg; ?></span></center>
			...
			<div class="col-xs-12 col-sm-12 no-padding">
			   ...
			   <input type="hidden" name="merchant_id" id="merchant_id_alipay" value="<?php echo $merchants_details['mer_map_id']; ?>">
			   <input type="hidden" name="date_12" id="date_12" value="<?php echo date('m/d/Y'); ?>">
				<div class="col-xs-3 col-sm-3">
					<div class="form-group"> <!-- Date input -->
						<label class="control-label" for="date">Start Date</label>
						<input class="form-control" id="period_start_date_alipay" name="date" placeholder="MM/DD/YYY" autocomplete="off" type="text"  />
					</div>
				</div>
				...
				<div class="col-xs-3 col-sm-3">
					<div class="form-group"> <!-- Date input -->
						...
						<input class="form-control" id="period_End_date_alipay" name="date" placeholder="MM/DD/YYY" autocomplete="off" type="text" />
					</div>
				</div>
...
<script>
	...
	function month_show_alipay() {
	    $('#today-payment_alipay').hide();
	    $('#today-payment_alipay1').hide();
	    $('#month-payment_alipay').show();
	    $('#month-payment_alipay1').show();
	    $('#week-payment_alipay').hide();
	    $('#week-payment_alipay1').hide();
	...
	function today_show_alipay() {
	    $('#today-payment_alipay').show();
	    $('#today-payment_alipay1').show();
	    $('#month-payment_alipay').hide();
	    $('#month-payment_alipay1').hide();
	    $('#week-payment_alipay').hide();
	    $('#week-payment_alipay1').hide();
	...
	function week_show_alipay() {
	    $('#today-payment_alipay').hide();
	    $('#today-payment_alipay1').hide();
	    $('#month-payment_alipay').hide();
	    $('#month-payment_alipay1').hide();
	    $('#week-payment_alipay').show();
	    $('#week-payment_alipay1').show();

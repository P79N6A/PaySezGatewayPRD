...
if($_GET['start_d']!='') {
    ...
    $query="SELECT * FROM merchants JOIN transaction_alipay ON transaction_alipay.merchant_id = merchants.mer_map_id AND merchants.userid= '$iid' AND transaction_alipay.transaction_type NOT IN ('4','s3') AND transaction_alipay.trans_datetime >= '$val1_excel' AND transaction_alipay.trans_datetime <= '$val2_excel' ORDER BY transaction_alipay.trans_datetime DESC";
    ...
    <TABLE width="100%" cellpadding="1" border="1" cellspacing="0">
        ...
        <?php $i=0; foreach($transactions_Excel as $tr) { $i++; ?>
            ...
            <tr>
                ...
                <td align="center" id="lt_edit"><?php echo $tr["cst_trans_datetime"]; ?></td>
    ...
    if($merchantid==0)
    {
        ...
        if($val1!='' && $val2!='' && $merchantid!=0){
            ...
            if(!empty($transactions)){
                ...
                foreach($transactions as $tr)
                {
                    ...
                    $result .= '<tr class="gradeX">
                                    ...
                                    <td><a target="_blank" href="transactiondetails_alipay.php?t_id='.$tr["id_transaction_id"].'"><i class="fa fa-folder-open fa-2x"></i></a></td>
                                </tr>';
                }
                $result .= '</tbody></table>';
            }
                    ...
                    if(!empty($transactions)){
                        ...
                        foreach($transactions as $tr) {
                            ...
                            $result .= '<tr class="gradeX">
                                            ...
                                            <td>'.$sta.'</td>
                                            <td>'.$tr["cst_trans_datetime"].'</td>
                                            <td>'.$tr["currency"].' '.$transaction_amount.'</td>							
                                            <td align="center"><a href="transactiondetails_alipay_popup.php?t_id='.$tr["id_transaction_id"].'" class="load-modal" data-toggle="modal" data-target="#myModal2'.$tr["id_transaction_id"].'" title="Click To View Details"><i class="glyphicon glyphicon-plus-sign" style="font-size: 20px;"></i></a></td>
                                        </tr>';
            ...
            if(isset($_POST['S_Date']) || $_POST['S_Date']!='' || isset($_GET['date']) || $_GET['date']!='') {
                ...
                // echo "<br>Hi12_2";
                $query="SELECT * FROM merchants JOIN transaction_alipay ON transaction_alipay.merchant_id = merchants.mer_map_id AND merchants.userid= '$iid' AND transaction_alipay.transaction_type NOT IN ('4','s3') AND transaction_alipay.trans_datetime >= '$val1' AND transaction_alipay.trans_datetime <= '$val2'";
                    ...
                    if(!empty($transactions)){
                        ...
                        foreach($transactions as $tr) {
                            ...
                            $result .= '<tr class="gradeX">
                                            ...
                                            <td>'.$tr["cst_trans_datetime"].'</td>
                                            <td>'.$tr["currency"].' '.$transaction_amount.'</td>							
                                            <td align="center"><a href="transactiondetails_alipay.php?t_id='.$tr["id_transaction_id"].'" title="Click To View Details"><i class="glyphicon glyphicon-plus-sign" style="font-size: 20px;"></i></a></td>
                                        </tr>';
                ...
                // echo "<br>Hi12_2";
                $query="SELECT * FROM merchants JOIN transaction_alipay ON transaction_alipay.merchant_id = merchants.mer_map_id AND merchants.userid= '$iid' AND transaction_alipay.transaction_type NOT IN ('4','s3') AND transaction_alipay.trans_datetime >= '$val1' AND transaction_alipay.trans_datetime <= '$val2' ORDER BY transaction_alipay.trans_datetime DESC";

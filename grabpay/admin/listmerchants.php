                             ...
                             <div class="row show-grid">
                                ...
                                <div class="col-md-16">
                                  ...
                                  <div class="panel panel-primary">
                                    ...
                                    <div class="panel-heading">Merchant Accounts  <div class="frmSearch">
                                        ...
                                        <input type="text" id="search-box" name="mer_name" placeholder="Search Merchant Name" style=" background: cadetblue;"/>
                                          ...
                                          <tbody>
                                            ...
                                            foreach($usersofuser as $row0){ 
                                              ...
                                              <tr class="gradeX" data-level="1" id="level_1_<?php echo $row0['mer_map_id']; ?>" class="agentuser">
                                               ...
                                               <td class="data"><?php echo $merchant_name=$row0['merchant_name']; ?></td>

                                               <td class="data"><?php echo $row0['csemail']; ?></td>

                                               <td class="data"><?php echo $row0['currency_code']; ?></td>
                                                                         
                                               <td class="data"><?php echo $active; ?></td>

                                               <td class="data">   
                                                
                                                 <input type="button" class = "btn btn-primary btn-xs" value="Details" onclick="window.location.href='merchant_Details.php?m_id=<?php echo base64_encode( json_encode($row0['mer_map_id']) ) ?>'" />

                                                 <input type="button" class = "btn btn-primary btn-xs" value="Edit" onclick="window.location.href='merchant_Editdetails.php?m_id=<?php echo base64_encode( json_encode($row0['mer_map_id']) ) ?>'" />
                                                
                                                 <button class = "btn btn-primary btn-xs" class="test" data-toggle = "modal" id="<?php echo $row0['merchant_name']; ?>" onclick="showdetails(this);" data-target="#confirm-submit" value="<?php echo $row0['mer_map_id']; ?>"<?php if($active == "Active") { ?> disabled <?php } ?>   > Delete </button> <?php if($active == "Active") { ?> <div class="help"><div class="info-box"> <a href="#" class="close-button">&times;</a> You active Merchant so
                                                  You will not be able to Delete from Merchant Account. </div><a class='help-button' href='#' title="Click to know more">[?]</a></div> <?php } ?>
                                                </td>
                                              </tr>
                                        <?php } } ?> 
             ...
             <div class="modal-dialog">
               <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <p> Merchant Name is &ensp;<span id="merchant_name"></span></p>
                 ...
                 <div class="modal-footer">
                      ...
                      <a href="#" id="submit" class="btn btn-success success" onclick="submitContactForm()">Submit</a>
                 </div>
               </div>
              </div>
            </div>
...
function submitContactForm(){
    ...
    $('.modal').modal('hide');
     ...
     $.ajax({
        url: "php/inc_reportsearch1.php",
        data: JSON.stringify({'m_id': mer_id, 'type':'getmerchantdetele'}),
        type: 'POST',
        success: function(data) {
          $('.modal').modal('hide');
  ...
  function showdetails(button) {
    ...
    // ajax request
    var mer_id = button.value;
    var mer_name = button.id;

    if ($(mer_id).attr('disabled')) {
       alert('hi'); // do sth if disabled
   } else {
  // do sth if enabled 
  }

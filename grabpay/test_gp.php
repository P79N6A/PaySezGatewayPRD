...
// return $myfile;     
// }
function random_msg($length_of_string) 
{ 
...
function random_partner($length_of_string) 
{ 
...
$method_type = "POST";
$refund_method_type = "PUT";
$cancel_method_type = "PUT";
$inquiry_method_type = "GET";
...
switch ($tran_req_type) {
    case "1": //QR request
        ...
        $parameter_ins = array(
            ...
            "gp_merchant_id" => 'GP0000000000001'
        );
    ...
    case "2": //Refund Request
        ...
        $request_param_log = "Application Log GP:".date("Y-m-d H:i:s") . " Refund Request Parameter Received from Mpos:" . json_encode($received_parameter) . " \n\n";
        poslogs($request_param_log);
    ...
    case "3": //Cancel Request
        ...
        $request_param_log = "Application Log GP:".date("Y-m-d H:i:s") . " Cancel Request Parameter Received from Mpos:" . json_encode($received_parameter) . " \n\n";
        poslogs($request_param_log);
...
// {"code":4040,"reason":"transaction not found"}
    ...
    case "4": //Inquiry Request
        ...
        $request_param_log = "Application Log GP:".date("Y-m-d H:i:s") . " Inquiry Request Parameter Received from Mpos:" . json_encode($received_parameter) . " \n\n";
        poslogs($request_param_log);
        ...
        $cst_time = $trans_result['gp_completedAt'];
        //$time_response = gmdate("Y-m-d H:i:s", $cst_time);
        $time_response = unixtotime($cst_time);
        ...
        $build_qry = '?'.'msgID='.$msgID.'&grabID='.$grabID.'&terminalID='.$terminal_id.'&currency='.$currency.'&txType='.$txType;
    ...
    $settle_received_data = "Application Log GP:".date("Y-m-d H:i:s") . " Settlement Received Data :" . json_encode($received_parameter) . " \n\n";

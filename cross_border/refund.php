...
<body>
	<div class="header">
		...
		<div class="container blue">
			<div class="title">支付宝境外收单(forex_refund)</div>
		</div>
	</div>
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			<div class="element" style="margin-top:60px;">
				<div class="legend">forex_refund </div>
			</div>
			<input type="hidden" name="tran_req_type" value="cb2">
			<input type="hidden" id="rand_no" name="rand_no" value="<?php echo $pin;?>">
			<div class="element">
				<div class="etitle">out_trade_no:</div>
				<div class="einput"><input type="text" name="WIDout_trade_no" value=""></div>
				<br>
			...
			<div class="element">
				<div class="etitle">Return Amount:</div>
				<div class="einput"><input type="text" name="refund_amount" value=""></div>
				<br>
				<div class="mark">Remarks: The product price in settlement currency</div>
			</div>
			<div class="element">
				<div class="etitle">Merchant Id:</div>
				<div class="einput"><input type="text" name="merchant_id" value="CB0000000000001"></div>
				<br>
				<div class="mark">Remarks: The Merchant Id </div>
			</div>
			<div class="element">
				<div class="etitle">Out Return No:</div>
				<div class="einput"><input type="text" name="out_return_no" id="out_return_no"></div>
				<br>
			...
			<div class="element" >
				<input type="submit" class="alisubmit" value ="Submit">
			</div>
		</form>
	</div>
	<div class="footer">
...
<script>
	...
	var showqrs = document.getElementById("showqrs");
	 ...
	 var out_return_no = document.getElementById("out_return_no");
	 var rndm_no = document.getElementById("rand_no").value;
	 ...
	 out_return_no.value = 'CB0000000000001'+ new Date().format("yyyyMMddhhmmss")+rndm_no;
</script>

...
<body>
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			...
			<input type="hidden" name="tran_req_type" value="cbo1">
			<input type="hidden" name="callback_notify_url" value="https://merchant_url">
			...
			<div class="element">
		                ...
		                <div class="einput"><input type="text" name="WIDsplit_fund_info" value="[{&#34;transIn&#34;:&#34;2088621921149582&#34;,&#34;amount&#34;:&#34;2.00&#34;,&#34;currency&#34;:&#34;USD&#34;,&#34;desc&#34;:&#34;Split _test1&#34;}]"></div>		        
		                </div>
...
<script>
	...
	var showqrs = document.getElementById("showqrs");
	 ...
	 out_trade_no.value = 'CB0000000000001'+ new Date().format("yyyyMMddhhmmss")+rndm_no;
</script>

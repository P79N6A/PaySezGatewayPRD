...
<body>
	<div class="header">
		...
		<div class="container blue">
			<div class="title">支付宝境外收单(single_trade_query)</div>
		</div>
	</div>
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			<div class="element" style="margin-top:60px;">
				<div class="legend">single_trade_query </div>
			</div>
			<input type="hidden" name="tran_req_type" value="cb3">
			<input type="hidden" id="rand_no" name="rand_no" value="<?php echo $pin;?>">
			<div class="element">
				<div class="etitle">Out Trade No:</div>

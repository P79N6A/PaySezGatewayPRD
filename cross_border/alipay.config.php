...
$alipay_config['partner']		= '2088621911512174';//'2088621921149582';//'2088621891276675';
...
$alipay_config['key']			= 'e7b8kwrnnky977fef6rmxypqzpr48xxz';//'m2bh74n5cq2d7ucmdi2zblflbwk0e3yu';//'6cgz2arb7djrp0ohrcz580a4sl1n0pfz';
...
$alipay_config['notify_url'] ="http://169.38.91.246/testspaysez/cross_border/notify_url.php";

$alipay_config['log-path']= '/var/www/html/testspaysez/cross_border/crossBorderPay.log'; //test
$alipay_config['alipay_url'] = "https://mapi.alipaydev.com/gateway.do?";
...
$alipay_config['return_url'] = "http://169.38.91.246/testspaysez/cross_border/return_url.php";
//签名方式
//sign_type
...
$alipay_config['service_re'] = "forex_refund";
$alipay_config['service_qry'] = "single_trade_query";

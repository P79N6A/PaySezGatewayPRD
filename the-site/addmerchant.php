...
require_once('php/inc_addmerchant.php');
 ?>       
<div class="row  border-bottom white-bg dashboard-header">
	...
	<div class="ibox-content">
                            ...
                            <p>
                                Please enter the new merchant's information in the fields provided below.
                            </p>

                            <form id="addmerchantform" action="#" method="POST" class="wizard-big">
                                <h1>Step 1</h1>
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="merchant_name" name="merchant_name" type="text" class="form-control required">
                                        </div>
                                        <div class="form-group">
                                            <label>Country</label>
                                ...
                                <h1>Step 3</h1>
								  <fieldset>
										...
										<p>The following bank information must be entered correctly as the gateway processing fee will be withdrawn from this account. If the information is invalid, the merchant will be suspended and no commission can be paid.</p>
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
								...
								<p>Enter a username which the merchant will use to log into their control panel. 
								The username must be 4 to 32 characters long and contain only letters and/or numbers. The password will be emailed to the merchant from last step.
								</p>
								<div class="col-lg-6">
                            	<div class="form-group">

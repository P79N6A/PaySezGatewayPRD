...
$currentdate = "2019-01-31 00:00:00";
$sdate="2019-01-31 23:59:59";
...
/**** Payment Success ****/
$sql_payment="SELECT * FROM transaction_alipay WHERE transaction_type IN ('1','s1','cb1') AND cst_trans_datetime >= '".$currentdate ."' AND cst_trans_datetime <='".$sdate ."' AND result_code='SUCCESS' AND trade_status IN ('TRADE_SUCCESS','TRADE_FINISHED') AND tlf_flag=0";
...
/**** Payment Refund ****/
$sql_payment_refund="SELECT * FROM transaction_alipay WHERE transaction_type IN ('2','s2','cb2') AND cst_trans_datetime >= '".$currentdate ."' AND cst_trans_datetime <='".$sdate ."' AND result_code='SUCCESS' AND tlf_flag=0";
